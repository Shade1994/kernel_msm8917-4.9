...
# huaqin add bringup nxp & foursemi smartpa add driver code by xudayi at 2019/07/15 start
$(shell rm -rf $(PRODUCT_OUT)/obj/vendor/qcom/opensource/audio-kernel/asoc/codecs/fs16xx/Module.symvers)
$(shell rm -rf $(PRODUCT_OUT)/obj/vendor/qcom/opensource/audio-kernel/asoc/codecs/tfa98xx/Module.symvers)
$(shell rm -rf $(PRODUCT_OUT)/obj/vendor/qcom/opensource/audio-kernel/asoc/codecs/aw8864/Module.symvers)
$(shell rm -rf $(PRODUCT_OUT)/obj/vendor/qcom/opensource/audio-kernel/asoc/codecs/aw882xx/Module.symvers)
$(shell rm -rf $(PRODUCT_OUT)/obj/vendor/qcom/opensource/audio-kernel/asoc/codecs/aw87359/Module.symvers)
$(shell rm -rf $(PRODUCT_OUT)/obj/vendor/qcom/opensource/audio-kernel/asoc/codecs/tas2562/Module.symvers)
include $(MY_LOCAL_PATH)/asoc/codecs/aw87359/Android.mk
include $(MY_LOCAL_PATH)/asoc/codecs/aw8864/Android.mk
include $(MY_LOCAL_PATH)/asoc/codecs/fs16xx/Android.mk
...
# huaqin add bringup nxp & foursemi smartpa add driver code by xudayi at 2019/07/15 end
